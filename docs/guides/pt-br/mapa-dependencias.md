...
Todas as skills de `misc/` (`reset-agent-env`, `setup-statusline`) e a maioria de `engineering/` e `productivity/` não citadas acima são independentes: instalam e funcionam sozinhas.
