...
If the verdict is **Nothing required**, skip saving: no file, no template block. Answer in chat with just the verdict line and the one sentence reason, and stop there.
